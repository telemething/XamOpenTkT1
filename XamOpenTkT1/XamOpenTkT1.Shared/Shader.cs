...
namespace TTOpenGl
{
    ...
    public class Shader
    {
        ...
        public Shader(string vertPath, string fragPath)
        {
            ...
            var shaderSource = LoadResource(vertPath);
            ...
            shaderSource = LoadResource(fragPath);
            ...
            int v1;
            ActiveUniformType v2;

            // Loop over all the uniforms,
            for (var i = 0; i < numberOfUniforms; i++)
            {
                // get the name of this uniform,
                var key = GL.GetActiveUniform(Handle, i, out v1, out v2);
        ...
        private static void CompileShader(int shader)
        {
            ...
            if (code != (int)All.True)
            {
                ...
                throw new Exception($"Error occurred whilst compiling Shader({shader}) : {errorText}");
            }
        }
        ...
        private static string LoadResource(string shaderName)
        {
            string prefix;
#if __IOS__
            prefix = "XamOpenTkT1.iOS.Shaders.";
#endif
#if __ANDROID__
            prefix = "XamOpenTkT1.Droid.Shaders.";
#endif
#if WINDOWS_UWP
            prefix = "XamOpenTkT1.UWP.Shaders.";
#endif
