...
namespace GLUWP.ES20
{
    public class GL
    {
        ...
        [DllImport(libGLESv2, EntryPoint = "glGenVertexArrays")]
        private static extern void glGenVertexArrays(int n, [In][Out] int[] buffers);

        public static int[] GenVertexArrays(int n)
        {
            int[] result = new int[n];
            glGenVertexArrays(n, result);
            return result;
        }

        [DllImport(libGLESv2, EntryPoint = "glBindVertexArray")]
        public static extern void BindVertexArray(int buffer);

        [DllImport(libGLESv2, EntryPoint = "glBindVertexArray")]
        public static extern void BindVertexArray(uint buffer);

        [DllImport(libGLESv2, EntryPoint = "glDeleteVertexArray")]
        public static extern void DeleteVertexArray(int buffer);

        [DllImport(libGLESv2, EntryPoint = "glDeleteVertexArray")]
        public static extern void DeleteVertexArray(uint buffer);
